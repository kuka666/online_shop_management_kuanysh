...
// .prepareStatement("Select id, name, email, password from customer where
...
// System.out.println("You have successfully logged in Customer: " +
// rs.getString("name"));
// } else {
...
// String sql = "insert into item (type,price,description) VALUES ('Jeans',
// '20', 'M size, Black')";
...
// try (Connection connection = connect()) {
// String sql = "insert into item (type,price,description) VALUES ('T-Shirt',
// '10', 'M size, Black')";
